...
public class ListItemRegistroBindingImpl extends ListItemRegistroBinding  {
    ...
    public ListItemRegistroBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.entradasaida == variableId) {
            setEntradasaida((com.fsct.android.appportaria.database.Registro) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setEntradasaida(@Nullable com.fsct.android.appportaria.database.Registro Entradasaida) {
        this.mEntradasaida = Entradasaida;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
        notifyPropertyChanged(BR.entradasaida);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.fsct.android.appportaria.database.Registro entradasaida = mEntradasaida;
